...
public class SmartCartService {
    ...
    public SmartCartService(int block, String key) {
    ...
    public String readString() throws CardException {
        return new String(read());
    }

    public void write(byte[] data) throws CardException {
        erase();
    ...
    public byte[] read() throws CardException {
        connect();
        authenticate();
